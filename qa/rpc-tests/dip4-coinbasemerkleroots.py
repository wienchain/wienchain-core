...
from test_framework.test_framework import WienchainTestFramework
...
class LLMQCoinbaseCommitmentsTest(WienchainTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as WienchainTestFramework doesn't support this atm)
