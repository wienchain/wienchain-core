# Linearize
Construct a linear, no-fork, best version of the Wienchain blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install wienchain_hash

https://github.com/wienchain/wienchain_hash
...
JSON-RPC server. Running `wienchaind` or `wienchain-qt -server` will be sufficient.
...
* `input`: wienchain blocks/ directory containing blkNNNNN.dat
