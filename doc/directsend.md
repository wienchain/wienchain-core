...
This mechanism has been integrated into Bitcore-Node-Wienchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wienchain/insight-api-wienchain#web-socket-api](https://github.com/wienchain/insight-api-wienchain#web-socket-api)
* API: [https://github.com/wienchain/insight-api-wienchain#directsend-transactions](https://github.com/wienchain/insight-api-wienchain#directsend-transactions)
