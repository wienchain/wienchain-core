...
This document provides guidelines for internationalization of the Wienchain software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wienchain_en.ts` remains unchanged.
