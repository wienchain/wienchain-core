...
#define BOOST_TEST_MODULE Wienchain Test Suite

#include "test_wienchain.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_wienchain_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
