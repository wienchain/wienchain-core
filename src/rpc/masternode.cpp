...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Wienchain address\n"
            "  payee          - Print the masternode payout Wienchain address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Wienchain address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_25000);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "wienchain",               "masternode",             &masternode,             true,  {} },
    { "wienchain",               "masternodelist",         &masternodelist,         true,  {} },
    { "wienchain",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "wienchain",               "exclusivesend",            &exclusivesend,            false, {} },
#endif // ENABLE_WALLET
};
